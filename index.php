        ...
        <section id="technology" class="tech-showcase-section">
            ...
            <div class="container tech-showcase-container">
                <div class="tech-header-center fade-in">
                    ...
                    <h2 class="tech-main-title">We are equipped with world's <br><span class="tech-gradient-text">most
        ...
        <section id="results" class="results section-padding bg-warm-light">
            <div class="container">
                <div class="section-header fade-in">
                    <h2>Transformations <span class="highlight">(Before & After)</span></h2>
                    ...
                    <div class="carousel-viewport">
                        <div class="carousel-track">
                            ...
                            <div class="review-card carousel-slide">
                                <div class="review-top">
                                    ...
                                    <div class="google-badge">
                                        <svg viewBox="0 0 24 24" width="20" height="20"><path fill="#4285F4" d="M23.5 12.3c0-.8-.1-1.7-.2-2.3H12v4.6h6.5c-.3 1.5-1.1 2.8-2.4 3.7l3.7 2.9c2.2-2 3.7-5 3.7-8.9z"/><path fill="#34A853" d="M12 23c3.2 0 6-1.1 8-3l-3.7-2.9c-1.1.7-2.5 1.2-4.3 1.2-3.1 0-5.8-2.3-6.7-5.2L1.6 15.9C3.5 19.7 7.4 23 12 23z"/><path fill="#FBBC05" d="M5.3 14.8C5.1 14 5 13.1 5 12s.1-2 .3-2.8L1.6 6.4C.6 8.4 0 10.1 0 12s.6 3.6 1.6 5.6l3.7-2.8z"/><path fill="#EA4335" d="M12 5c1.6 0 3 .6 4.1 1.7l3.1-3.1C17.3 1.8 14.8 1 12 1 7.4 1 3.5 3.6 1.6 7.4l3.7 2.8C6.2 7.3 8.9 5 12 5z"/></svg>
                                    </div>
                                </div>
                                <p class="review-text">"Dr. Mathpal is an exceptional dentist. I got my dental implants done here, and the entire process was painless and perfectly managed. Highly recommended!"</p>
                            ...
                            <div class="review-card carousel-slide">
                                ...
                                <p class="review-text">"This dental clinic exceeded my expectations! The staff was knowledgeable, friendly, and the smile designing treatments were highly effective."</p>
                                <div class="review-author">
                            ...
                            <div class="review-card carousel-slide">
                                ...
                                <p class="review-text">"I was terrified of root canals, but Dr. Mathpal made it completely painless. The use of advanced laser technology here is truly astounding."</p>
                                <div class="review-author">
                            ...
                            <div class="review-card carousel-slide">
                                ...
                                <p class="review-text">"From the digital 3D scans to the permanent Zirconia crown, everything felt premium and professional. Best dental experience in New Delhi!"</p>
                                <div class="review-author">
