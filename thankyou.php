...
<head>
    ...
    <meta name="description"
        content="Thank you for contacting Dr. Gaurav Mathpal's dental clinic in New Delhi. Your appointment request has been received and our care coordination team will connect with you shortly.">
        ...
        <section class="page-header thankyou-hero-section">
            <div class="container thankyou-hero-container">
                ...
                <div class="fade-in thankyou-check-circle">
                    <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" stroke-width="3"
                ...
                <h1 class="page-title fade-in-up thankyou-heading">
                    Thank
                    You<?php echo !empty($patient_name) ? ', <span class="italic-green">' . $patient_name . '</span>' : ''; ?>!
                </h1>
        ...
        <section class="section-padding ut-bg-white-upper">
            <div class="container">
                <div class="section-header text-center fade-in ut-mb-3-5rem">
                    ...
                    <p class="ut-style-33">We strive to provide a seamless, stress-free experience from your very first
                        interaction.</p>
                </div>
                ...
                <div class="ut-style-58">
                    ...
                    <div class="contact-card fade-in-up ut-style-3">
                        ...
                        <p class="ut-style-34">
                            Our patient care coordinator reviews your inquiry and coordinates with Dr. Mathpal's
                            operatory schedule to reserve the ideal consultation slot.
                        </p>
                    </div>
                    ...
                    <div class="contact-card fade-in-up ut-style-4">
                        ...
                        <p class="ut-style-34">
                            Within 2 to 4 business hours, our team will connect with you via phone or WhatsApp to
                            finalize your preferred time and answer any preliminary questions.
                        </p>
                    </div>
                ...
                <div class="fade-in-up ut-style-17">
                    <div class="ut-flex-1-1-450px">
                        ...
                        <p class="ut-style-39">
                            If you are experiencing severe dental pain, a damaged restoration, or acute trauma, don't
                            wait. Contact our front desk directly for priority same-day emergency triage.
                        </p>
                    </div>
        ...
        <section class="section-padding bg-soft-teal ut-style-22">
            <div class="container">
                <div class="section-header text-center fade-in ut-margin-bottom-3rem">
                    ...
                    <p class="ut-style-33">Learn more about Dr. Mathpal's research, specialized treatments, and clinical
                        philosophy.</p>
                </div>
                ...
                <div class="ut-style-59">
                        ...
                        <div>
                            <div class="ut-style-133">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    ...
                                    <path d="M20 20a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v14Z">
                                    </path>
                            ...
                            <p class="ut-style-32">
                                PhD, MDS, BDS, CEP (IIT Delhi). Discover our international UK patents, biomedical
                                research publications, and over 10+ years of Prosthodontic leadership.
                            </p>
                        </div>
                        <a class="ut-style-28" href="about.php">
                            Read Full Profile <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                    ...
                    <div class="contact-card fade-in-up ut-style-8">
                        <div>
                            ...
                            <p class="ut-style-32">
                                From computer-guided 3D Dental Implants to Full Mouth Rehabilitation and Hollywood Smile
                                Designing, explore our painless clinical procedures.
                            </p>
                        </div>
                        <a class="ut-style-28" href="rehabilitation.php">
                            Explore Treatments <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                                <line x1="5" y1="12" x2="19" y2="12"></line>
                                <polyline points="12 5 19 12 12 19"></polyline>
                            </svg>
                    ...
                    <div class="contact-card fade-in-up ut-style-9">
                        ...
                        <a class="ut-style-28" href="contact.php">
                            Get Directions <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                                <line x1="5" y1="12" x2="19" y2="12"></line>
                                <polyline points="12 5 19 12 12 19"></polyline>
                            </svg>
