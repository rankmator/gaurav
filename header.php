...
<div class="topbar">
    <div class="topbar-container">
        ...
        <div class="topbar-socials">
            <span>Follow Us:</span>
            <a href="https://www.facebook.com/panaceadental" target="_blank" aria-label="Facebook"><svg width="14"
                    height="14" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                </svg></a>
            <a href="https://www.instagram.com/panacea_clinic_r/" target="_blank" aria-label="Instagram"><svg width="14"
            ...
            <a href="https://www.youtube.com/channel/UCWmA77bYwksKciQaOdCvr8w" target="_blank" aria-label="YouTube"><svg
            ...
            <a href="https://x.com/DrGauravMaiv" target="_blank" aria-label="X (Twitter)"><svg width="14" height="14"
            ...
            <a href="https://www.linkedin.com/in/drgauravmathpal-panacea-68228341b/" target="_blank"
                aria-label="LinkedIn"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
    ...
    <div class="container nav-container">
        ...
        <nav>
            <ul id="primary-navigation" data-visible="false" class="primary-navigation">
                <li><a href="index.php"
                        class="<?php echo ($cur_script === 'index.php' || $cur_script === '') ? 'active' : ''; ?>">Home</a>
                </li>
