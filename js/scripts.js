document.addEventListener('DOMContentLoaded', () => {
    ...
    const handleSendMessage = (text) => {
        ...
        setTimeout(() => {
            ...
            addMessage(formattedReply + `<br><br><a href="contact.html" style="display:inline-block;margin-top:6px;background:#10B981;color:#fff;padding:6px 14px;border-radius:12px;font-size:0.8rem;font-weight:600;text-decoration:none;">📅 Book Appointment</a>`, 'assistant', true);
        }, 1200);
    };
