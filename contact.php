        ...
        <section class="about-hero">
            <div class="container">
                <div class="about-hero-content fade-in-up contact-hero-center">
                    ...
                    <h1 class="hero-title">
                        Contact Our <br>
                        <span class="highlight">Specialist Care Team</span>
                    </h1>
                ...
                <div class="profile-stats-grid fade-in-up contact-stats-margin">
                    <div class="profile-stat-item">
                        <span class="stat-num">10:30 AM</span>
                        <span class="stat-lbl">Daily Opening Time</span>
                    </div>
                    <div class="profile-stat-item">
                        <span class="stat-num">Zero Wait</span>
                        <span class="stat-lbl">Priority Booking Slots</span>
                    </div>
                    <div class="profile-stat-item">
                        <span class="stat-num">New Ashok Nagar</span>
                        <span class="stat-lbl">Central New Delhi Clinic</span>
                    </div>
                    <div class="profile-stat-item">
                        <span class="stat-num">100%</span>
                        <span class="stat-lbl">Painless Laser Protocol</span>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container contact-container">
                ...
                <div class="contact-grid">
                    ...
                    <div class="contact-form-container contact-card fade-in-up contact-form-card">
                        <form id="contact-form" class="contact-form contact-form-layout" action="mail1.php"
                            method="POST">
                            ...
                            <div class="form-group contact-form-group-flex">
