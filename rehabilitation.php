...
<body>
    ...
    <main>
            ...
            <div class="container">
                <div class="about-hero-grid">
                    <div class="about-hero-content fade-in-up">
                        <span class="badge hero-badge">
                            ...
                            100% Painless Rehabilitation
                        </span>
                        <h1 class="hero-title">
                            Rebuild Your Bite. <br>
                            <span class="highlight">Restore Complete Function.</span>
                        </h1>
                        ...
                        <div class="about-floating-badge ut-style-48">
                            ...
                            <div>
                                <strong class="ut-style-26">99.4% Success
                                    Rate</strong>
                                <span class="ut-style-73">Over 1,500+ Full Rehabs Placed</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="profile-stats-grid fade-in-up ut-style-109">
                    <div class="profile-stat-item">
                        ...
                        <span class="stat-lbl">Full Rehabs Placed</span>
                    </div>
                    <div class="profile-stat-item">
                        <span class="stat-num">99.4%</span>
                        <span class="stat-lbl">Functional Success Rate</span>
                    </div>
                    <div class="profile-stat-item">
                        <span class="stat-num">100%</span>
                        <span class="stat-lbl">Neuromuscular Alignment</span>
                    </div>
                    <div class="profile-stat-item">
                        <span class="stat-num">Zero-Pain</span>
                        <span class="stat-lbl">Piezosurgery Guided</span>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- Tailored Rehabilitation Solutions (Modern 3-Column Grid matching reference design) -->
            ...
            <div class="container">
                ...
                <div class="comparison-table-wrapper fade-in-up">
                    <table class="seo-comparison-table">
                        ...
                        <tbody>
                            <tr>
                                <td><strong>Diagnostic Mapping</strong></td>
                                <td class="highlight-cell">3D CBCT & Digital Facebow Jaw Tracking</td>
                                <td>Basic 2D X-rays & manual impression biting</td>
                            </tr>
                            <tr>
                                <td><strong>TMJ Joint Protection</strong></td>
                                <td class="highlight-cell">Centric relation joint stabilization prior to build</td>
                                <td>Restoring teeth directly into strained bite planes</td>
                            </tr>
                            <tr>
                                <td><strong>Prosthetic Material</strong></td>
                                <td class="highlight-cell">Multi-layered monolithic Zirconia & Titanium</td>
                                <td>Prone-to-chipping PFM porcelain or acrylic</td>
                            </tr>
                            <tr>
                                <td><strong>Vertical Dimension</strong></td>
                                <td class="highlight-cell">Mathematically restored vertical facial height</td>
                                <td>Arbitrary height leading to premature facial aging</td>
                            </tr>
                            <tr>
                                <td><strong>Long-Term Longevity</strong></td>
                                <td class="highlight-cell">15 to 20+ Years with zero joint strain</td>
                                <td>Frequent ceramic fractures and bite collapse</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <!-- Doctor Section (Rehabilitation Specialist Profile) -->
                ...
                <div class="doctor-profile-card fade-in-up">
                    <div class="doctor-profile-image-col">
                        <img src="img/Dr.-Gaurav-Mathpal-1152x1536.jpeg"
                            alt="Dr. Gaurav Mathpal Reconstructive Specialist" class="profile-card-img">
                    </div>
                    <div class="doctor-profile-content-col">
                        ...
                        <div class="profile-stats-grid">
                            ...
                            <div class="profile-stat-item">
                                <span class="stat-num">99.4%</span>
                                <span class="stat-lbl">Functional Success</span>
                            </div>
                            <div class="profile-stat-item">
                                <span class="stat-num">100%</span>
                                <span class="stat-lbl">TMJ Alignment</span>
                            </div>
                            <div class="profile-stat-item">
                                <span class="stat-num">Zero Pain</span>
                                <span class="stat-lbl">Laser & Piezo Stage</span>
                            </div>
                        </div>
                        ...
                        <div class="profile-actions">
                            <a href="#contact" class="btn profile-btn-primary">Book Rehabilitation Assessment</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="review-card carousel-slide">
                                ...
                                <div class="review-author">
                                    ...
                                    <div class="author-details">
                                        <h4>Alok Verma</h4>
                                        <span class="verified-tag">✓ Verified Rehab Patient</span>
                                    </div>
                                </div>
                            </div>
        ...
        <section id="faq" class="section-padding textured-bg ut-style-112">
            <div class="container">
                <div class="section-header text-center fade-in">
                    ...
                    <div class="contact-form-container contact-card fade-in-up ut-delay-1">
                        <form id="contact-form" class="contact-form ut-style-53" action="mail1.php" method="POST">
                            <h3 class="ut-style-49">
                                ...
                                Request Rehabilitation Assessment
                            </h3>
